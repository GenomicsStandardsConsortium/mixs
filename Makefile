...
test: ## runs tests
	...
	#$(CMD) pytest --cov=src --cov-report html:tests/.coverage $(TESTS_DIR) # MAM 2023-09-28 # https://github.com/GenomicsStandardsConsortium/mixs6.2_release_candidate/issues/20
.PHONY: test
