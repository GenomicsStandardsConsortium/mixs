...
```
## MixsCompliantData-MimsSoil-multivalued-example
### Input
```yaml
mims_soil_data:
- agrochem_addition:
  - roundup;5 milligram per liter;2018-06-21
  - glyphosate;10 milligram per liter;2019-03-15
  ...
  lat_lon: 41.9 -93.6
  project_name: Bracketed pipes
  samp_name: brackets1
  samp_taxon_id: soil metagenome [NCBITaxon:410658]
  seq_meth: Illumina HiSeq
  sop:
  - https://doi.org/10.1234/sop1
  - https://doi.org/10.1234/sop2
  tillage:
  - chisel
  - ridge till
- agrochem_addition:
...
- agrochem_addition:
  ...
  lat_lon: 48.1 11.6
  project_name: Spaced pipes
  samp_name: spaced3
  samp_taxon_id: soil metagenome [NCBITaxon:410658]
  seq_meth: Oxford Nanopore
  sop:
  - https://doi.org/10.1234/sop1
  - https://doi.org/10.1234/sop2
  tillage:
...
- agrochem_addition:
  ...
  depth: 0.8 m
  elev: 100 m
  env_broad_scale: tropical ecosystem [ENVO:01001784]
  env_local_scale: wetland [ENVO:00000043]
  env_medium:
  - soil [ENVO:00001998]
  geo_loc_name: 'Brazil: Amazonas, Manaus'
  lat_lon: -3.1 -60.0
  project_name: Single values
  samp_name: single4
  samp_taxon_id: soil metagenome [NCBITaxon:410658]
  seq_meth: PacBio Sequel
  sop:
  - https://doi.org/10.1234/sop1
  tillage:
  - chisel
...
```
## MixsCompliantData-MimsMisipSoil-reference-patterns
### Input
```yaml
mimsmisip_soil_data:
- collection_date: '2013-03-25T12:42:31+01:00'
  ...
  geo_loc_name: 'text: text, text'
  gradient_position: 1
  internal_standard: PMID:87654321
  isotope:
  - 13C
  - 15N
  isotopolog:
  ...
  lat_lon: 45.1 45.9
  project_name: absolutely any text
  samp_name: misip-reference-pmid
  samp_taxon_id: Gut Metagenome [NCBITaxon:749906]
  seq_meth: absolutely any text
  sip_method: PMID:12345678
- collection_date: '2013-03-25T12:42:31+01:00'
  depth: 1.234 units
  elev: 1.234 units
  env_broad_scale: term [ONTOLOGY:123]
  ...
  geo_loc_name: 'text: text, text'
  gradient_position: 1
  internal_standard: doi:10.17504/protocols.io.abc123
  isotope:
  - 13C
  - 15N
  isotopolog:
  ...
  lat_lon: 45.1 45.9
  project_name: absolutely any text
  samp_name: misip-reference-doi
  samp_taxon_id: Gut Metagenome [NCBITaxon:749906]
  seq_meth: absolutely any text
  sip_method: doi:10.1038/nbt.1823
- collection_date: '2013-03-25T12:42:31+01:00'
  depth: 1.234 units
  elev: 1.234 units
  env_broad_scale: term [ONTOLOGY:123]
  ...
  geo_loc_name: 'text: text, text'
  gradient_position: 1
  internal_standard: https://www.protocols.io/view/internal-standard
  isotope:
  - 13C
  - 15N
  isotopolog:
...
```
## MixsCompliantData-MimsSoil-invalid-env_medium-scalar
### Input
```yaml
mims_soil_data:
- al_sat_meth: PMID:12345678
  ...
  lat_lon: 41.9 -93.6
  previous_land_use: corn cultivation;2020-09-15T10:00:00Z
  project_name: env_medium must be a list, not a scalar
  samp_name: soil-invalid-env_medium-scalar
  samp_taxon_id: soil metagenome [NCBITaxon:410658]
  seq_meth: PMID:98765432
...
```
## MixsCompliantData-MimsMisipSoil-invalid-internal_standard-prose
### Input
```yaml
mimsmisip_soil_data:
- collection_date: '2013-03-25T12:42:31+01:00'
  ...
  geo_loc_name: 'text: text, text'
  gradient_position: 1
  internal_standard: see the supplementary methods section
  isotope:
  - 13C
  - 15N
  isotopolog:
  ...
  lat_lon: 45.1 45.9
  project_name: absolutely any text
  samp_name: misip-invalid-internal_standard
  samp_taxon_id: Gut Metagenome [NCBITaxon:749906]
  seq_meth: absolutely any text

```
## MixsCompliantData-MimsSoil-invalid-env_medium-malformed-element
### Input
```yaml
mims_soil_data:
- al_sat_meth: PMID:12345678
  ...
  lat_lon: 41.9 -93.6
  previous_land_use: corn cultivation;2020-09-15T10:00:00Z
  project_name: each env_medium element must carry a [termID]
  samp_name: soil-invalid-env_medium-malformed-element
  samp_taxon_id: soil metagenome [NCBITaxon:410658]
  seq_meth: PMID:98765432
...
```
## MimsMisipSoil-isotopolog_incu_time
### Input
```yaml
mimsmisip_soil_data:
- collection_date: '2013-03-25T12:42:31+01:00'
...
```
## MixsCompliantData-MimsMisipSoil-invalid-sip_method-no-scheme
### Input
```yaml
mimsmisip_soil_data:
- collection_date: '2013-03-25T12:42:31+01:00'
  ...
  lat_lon: 45.1 45.9
  project_name: absolutely any text
  samp_name: misip-invalid-sip_method
  samp_taxon_id: Gut Metagenome [NCBITaxon:749906]
  seq_meth: absolutely any text
  sip_method: Smith et al 2019, Journal of Stable Isotope Probing
